  ...
  const featuredProjects = [
    {
      ...
      title: "Grabity",
      isFeatured: true,
      description: "Grabity is a physics-driven top-down survival game built on our team's custom game engine. I served as Product Manager and led core gameplay development.",
    ...
    },
    {
      ...
      title: "AzureVania",
      isFeatured: true,
      description: "A 2D mini Metroidvania Unity game project. My role included handling Multiplayer Networking, Level Design and Enemy AIs.",
    ...
    },
    {
      ...
      title: "Obelisk",
      isFeatured: true,
      description: "Obelisk is a large-scale interdisciplinary VR project. I acted as Team Leader and Programming Lead, managing technical direction and Oculus VR implementation.",
      ...
      skills: [
        ...
        { src: PlayStation, label: "PS4 Devkit" },
      ],
    },
  ];
    ...
    <section>
      ...
      <Container style={{ marginTop: "50px" }}>
        <h1 className="project-heading" style={{ textAlign: "center" }}>
          Notable <strong className="cyan"> Projects</strong>
        </h1>
